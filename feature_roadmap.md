...
- [x] **Passwort zurücksetzen** — Kein "Passwort vergessen"-Flow. User die ihr Passwort vergessen haben sind ausgesperrt.
...
- [x] **Review liken** — `toggleReviewLike()` und `getReviewLikeCount()` sind implementiert, aber `ReviewCard.jsx` zeigt keine Like-Schaltfläche an.
- [x] **404-Seite** — Kein Fallback-Route, ungültige URLs zeigen eine leere Seite.
- [x] **Filter zurücksetzen** — Auf der ExplorePage gibt es keinen "Filter löschen"-Button. Aktive Filter werden nicht angezeigt.
